...
data = pd.read_csv("bank_customer_revival.csv",encoding='Latin1')
...
def class_distribution(data, column_name='revival_flag'):
...
class_distribution(data, 'revival_flag')
...
X = data.drop("revival_flag", axis = 1)
